function Slider(slider) {
  ...
  function move(direction) {
    ...
    if (direction === "back") {
      ...
      // and destructure them over and into
      // the prev, current and next variables
      [prev, current, next] = [
        // get the prev slide, if there is none, get the last
        // slide from the entire slider for wrapping
      ...
      [prev, current, next] = [
        ...
        // loop around and grap the first slide
